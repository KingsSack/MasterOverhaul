...
import com.lasteditguild.overhaul.blocks.workbench.entity.InfusionTableBlockEntity;
...
public class WorkbenchInitializer {
    ...
    public static final ScreenHandlerType<InfusionTableScreenHandler> INFUSION_TABLE_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(InfusionTableScreenHandler::new);
