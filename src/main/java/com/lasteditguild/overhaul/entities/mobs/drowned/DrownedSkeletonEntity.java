...
public class DrownedSkeletonEntity extends ZombieEntity implements RangedAttackMob {
    public static final float field_30460 = 0.03F;
    boolean targetingUnderwater;
    protected final SwimNavigation waterNavigation;
    protected final MobNavigation landNavigation;

    public DrownedSkeletonEntity(EntityType<? extends DrownedSkeletonEntity> entityType, World world) {
        super(entityType, world);
        this.stepHeight = 1.0F;
        this.moveControl = new DrownedSkeletonEntity.DrownedMoveControl(this);
    ...
    protected void initCustomGoals() {
        this.goalSelector.add(1, new DrownedSkeletonEntity.WanderAroundOnSurfaceGoal(this, 1.0));
        this.goalSelector.add(2, new DrownedSkeletonEntity.TridentAttackGoal(this, 1.0, 40, 10.0F));
        this.goalSelector.add(2, new DrownedSkeletonEntity.DrownedAttackGoal(this, 1.0, false));
        this.goalSelector.add(5, new DrownedSkeletonEntity.LeaveWaterGoal(this, 1.0));
        this.goalSelector.add(6, new DrownedSkeletonEntity.TargetAboveWaterGoal(this, 1.0, this.world.getSeaLevel()));
        this.goalSelector.add(7, new WanderAroundGoal(this, 1.0));
        this.targetSelector.add(1, (new RevengeGoal(this, new Class[]{DrownedSkeletonEntity.class})).setGroupRevenge(new Class[]{ZombifiedPiglinEntity.class}));
    ...
    public static boolean canSpawn(EntityType<DrownedSkeletonEntity> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
    ...
    public void attack(LivingEntity target, float pullProgress) {
        ...
        tridentEntity.setVelocity(d, e + g * 0.20000000298023224, f, 1.6F, (float)(14 - this.world.getDifficulty().getId() * 4));
    ...
    private static class DrownedMoveControl extends MoveControl {
        ...
        public DrownedMoveControl(DrownedSkeletonEntity drowned) {
            super(drowned);
    ...
    static class TridentAttackGoal extends ProjectileAttackGoal {
        ...
        public TridentAttackGoal(RangedAttackMob rangedAttackMob, double d, int i, float f) {
            ...
            this.drowned = (DrownedSkeletonEntity)rangedAttackMob;
        }
    ...
    private static class DrownedAttackGoal extends ZombieAttackGoal {
        ...
        public DrownedAttackGoal(DrownedSkeletonEntity drowned, double speed, boolean pauseWhenMobIdle) {
    ...
    private static class LeaveWaterGoal extends MoveToTargetPosGoal {
        ...
        public LeaveWaterGoal(DrownedSkeletonEntity drowned, double speed) {
    ...
    private static class TargetAboveWaterGoal extends Goal {
        ...
        public TargetAboveWaterGoal(DrownedSkeletonEntity drowned, double speed, int minY) {
            this.drowned = drowned;
            this.speed = speed;
            this.minY = minY;
        }
